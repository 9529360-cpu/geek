...
You are the live worker temporarily bound to `command-pmo--factory-commander` for task `CPM-0001`.
...
- `C:\Users\bz977\.codex\.chatgpt-projects\g-p-6a88a9bf82a881918dbd66f29c739b4f\geek-work\00-command-center\geek-android\00-command-center\tasks\CPM-0001.json`
- `C:\Users\bz977\.codex\.chatgpt-projects\g-p-6a88a9bf82a881918dbd66f29c739b4f\geek-work\00-command-center\geek-android\10-departments\command-pmo\manager\ROLE_SKILLS.md`
- `C:\Users\bz977\.codex\.chatgpt-projects\g-p-6a88a9bf82a881918dbd66f29c739b4f\geek-work\00-command-center\geek-android\10-departments\command-pmo\manager\RULES.md`
...
Compile the owned-path task DAG, worker packets, and integration plan

## Owned paths

- 02-shared-knowledge/build-specimen/execution-blueprint.json
- 30-evidence/CPM-0001/**

## Acceptance criteria

- Output validates against workflow stage execution-blueprint schema
...
- Workflow: `intent-to-build` / stage `execution-blueprint`
...
- Attempt limit: `3`
- Source hashes: `{"02-shared-knowledge/build-specimen/experience-contract.json": "689a5d143f6ee5d67f333accef9e268376d925769677dd625f7fb51a1b3d183f"}`
- Output schema: `{"properties": {"integration_plan": {"type": "array"}, "rollback_plan": {"type": "array"}, "task_dag": {"type": "array"}, "worker_packets": {"type": "array"}}, "required": ["task_dag", "worker_packets", "integration_plan", "rollback_plan"], "type": "object"}`
- Routing rules: `{"allow": {"next_task": "QAA-0001"}, "block": {"next_task": null}, "defer": {"next_task": "CPM-0001"}}`

## Local verification commands

- python "C:\Users\bz977\.codex\skills\n-forge\scripts\advance_workflow.py" --project "<project>" --task CPM-0001 --result "<result.json>"
