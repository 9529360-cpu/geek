...
You are the live worker temporarily bound to `product-requirements--product-manager` for task `PRD-0001`.
...
- `C:\Users\bz977\.codex\.chatgpt-projects\g-p-6a88a9bf82a881918dbd66f29c739b4f\geek-work\00-command-center\geek-android\00-command-center\tasks\PRD-0001.json`
- `C:\Users\bz977\.codex\.chatgpt-projects\g-p-6a88a9bf82a881918dbd66f29c739b4f\geek-work\00-command-center\geek-android\10-departments\product-requirements\agents\product-manager\ROLE_SKILLS.md`
- `C:\Users\bz977\.codex\.chatgpt-projects\g-p-6a88a9bf82a881918dbd66f29c739b4f\geek-work\00-command-center\geek-android\10-departments\product-requirements\agents\product-manager\RULES.md`
- `C:\Users\bz977\.codex\.chatgpt-projects\g-p-6a88a9bf82a881918dbd66f29c739b4f\geek-work\00-command-center\geek-android\02-shared-knowledge\build-specimen\research.json` (`sha256:7cb02e366dcb5379f352e99de4dddd859cce97efc77dd3d653ef57bc5eb95e17`)
- Relevant source and contracts named by the task

## Outcome

Compile user workflows, scope, and measurable product acceptance

## Owned paths

- 02-shared-knowledge/build-specimen/product-contract.json
- 30-evidence/PRD-0001/**

## Acceptance criteria

- Output validates against workflow stage product-contract schema
...
- Workflow: `intent-to-build` / stage `product-contract`
...
- Attempt limit: `3`
- Source hashes: `{"02-shared-knowledge/build-specimen/research.json": "7cb02e366dcb5379f352e99de4dddd859cce97efc77dd3d653ef57bc5eb95e17"}`
- Output schema: `{"properties": {"acceptance_oracles": {"type": "array"}, "actors": {"type": "array"}, "non_goals": {"type": "array"}, "requirements": {"type": "array"}, "workflows": {"type": "array"}}, "required": ["actors", "requirements", "workflows", "non_goals", "acceptance_oracles"], "type": "object"}`
- Routing rules: `{"allow": {"next_task": "ARC-0001"}, "block": {"next_task": null}, "defer": {"next_task": "PRD-0001"}}`

## Local verification commands

- python "C:\Users\bz977\.codex\skills\n-forge\scripts\advance_workflow.py" --project "<project>" --task PRD-0001 --result "<result.json>"
