...
(() => {
  ...
  assert.match(workerSource, /translate\(text, source, target, env, deadlineAt\)/, 'provider failover must share one absolute request deadline while carrying source semantics');
