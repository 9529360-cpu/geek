...
assert.match(mainEntry, /allowedKeys:\s*\[\.\.\.ACCOUNT_DATA_KEYS, \.\.\.BROADCAST_ACCOUNT_DATA_KEYS\]/, 'runtime account-data store must install the explicit broadcast key extension');
