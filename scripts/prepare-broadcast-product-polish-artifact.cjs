...
const installerName = `geek-${pkg.version}-broadcast-product-polish-${short}.exe`;
...
const manifest = {
  purpose: 'broadcast-product-polish-real-client-validation',
  sourceCommit: process.env.GITHUB_SHA || null,
  productHead: 'cbe37435d60eecb51e12cbed03b79145b3d926f4',
