...
const installerName = `geek-${pkg.version}-broadcast-formal-ux-${short}.exe`;
...
const manifest = {
  purpose: 'broadcast-formal-ux-real-client-validation',
  sourceCommit: process.env.GITHUB_SHA || null,
  productHead: '7402629f248202e977bd6a6b9814cb2dbf9038e3',
